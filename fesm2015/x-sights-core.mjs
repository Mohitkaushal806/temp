...
class DataService {
    constructor(http) {
        ...
        this.entryMode = '1';
        this.authKey = '';
        this.entryMode = (_a = localStorage.getItem("xsights_entrymode")) !== null && _a !== void 0 ? _a : "0";
        this.authKey = (_b = localStorage.getItem("xsights_authkey")) !== null && _b !== void 0 ? _b : "";
    }
    setHeaders(adminId) {
        return {
            version: '1.0',
    ...
    keyConverter(graphData, dataKeys, direction = 1) {
        ...
        if (direction === 1) {
            graphData.rows = graphData.rows.map((row) => {
                ...
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : row;
            });
            graphData.columns = graphData.columns.map((column) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.col_name == column);
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : column;
            });
            ...
            if (graphData.colToShow != null) {
                ...
                graphData.colToShow = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : graphData.colToShow;
            }
            graphData.aggregationFunctions = graphData.aggregationFunctions.map((func) => {
                ...
                return Object.assign(Object.assign({}, func), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : func.variableName });
            });
            graphData.filter.xAxis = graphData.filter.xAxis.map((f) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.col_name == f.variableName);
                return Object.assign(Object.assign({}, f), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : f.variableName });
            });
            ...
            graphData.filter.customFilter = graphData.filter.customFilter.map((f) => {
                ...
                return Object.assign(Object.assign({}, f), { customFiltervar1: (_a = dataKey1 === null || dataKey1 === void 0 ? void 0 : dataKey1.col_title) !== null && _a !== void 0 ? _a : f.customFiltervar1, customFiltervar2: (_b = dataKey2 === null || dataKey2 === void 0 ? void 0 : dataKey2.col_title) !== null && _b !== void 0 ? _b : f.customFiltervar2, customFiltervar3: (_c = dataKey3 === null || dataKey3 === void 0 ? void 0 : dataKey3.col_title) !== null && _c !== void 0 ? _c : f.customFiltervar3 });
            });
                ...
                if (variable.is_filter || variable.is_slab) {
                    variable.filters = variable.filters.map((f) => {
                        ...
                        if (!f.isCustomValue) {
                            ...
                            f.values = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : f.values;
                        }
                        f.conditions = f.conditions.map((condition) => {
                            var _a;
                            let dataKey = dataKeys.find((key) => key.col_name == condition.variable.name);
                            condition.variable.name =
                                (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : condition.variable.name;
                            return condition;
                        });
                        return f;
                    });
                    ...
                    variable.operation = variable.operation.map((op) => {
                        ...
                        if (!op.isCustomValue) {
                            ...
                            op.value = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : op.value;
                        }
                        return op;
                    });
                }
            ...
            graphData.dataFormat = graphData.dataFormat.map((format) => {
                ...
                return Object.assign(Object.assign({}, format), { name: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_title) !== null && _a !== void 0 ? _a : format.name });
            });
        }
        else {
            graphData.rows = graphData.rows.map((row) => {
                ...
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : row;
            });
            graphData.columns = graphData.columns.map((column) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.col_title == column);
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : column;
            });
            graphData.lastLevelColumns = graphData.lastLevelColumns.map((column) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.col_title == column);
            ...
            if (graphData.colToShow != null) {
                ...
                graphData.colToShow = (_b = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _b !== void 0 ? _b : graphData.colToShow;
            }
            graphData.aggregationFunctions = graphData.aggregationFunctions.map((func) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.col_title == func.variableName);
                return Object.assign(Object.assign({}, func), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : func.variableName });
            });
            graphData.filter.xAxis = graphData.filter.xAxis.map((f) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.col_title == f.variableName);
                return Object.assign(Object.assign({}, f), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : f.variableName });
            });
            graphData.filter.yAxis = graphData.filter.yAxis.map((f) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.col_title == f.variableName);
            ...
            graphData.filter.customFilter = graphData.filter.customFilter.map((f) => {
                ...
                return Object.assign(Object.assign({}, f), { customFiltervar1: (_a = dataKey1 === null || dataKey1 === void 0 ? void 0 : dataKey1.col_name) !== null && _a !== void 0 ? _a : f.customFiltervar1, customFiltervar2: (_b = dataKey2 === null || dataKey2 === void 0 ? void 0 : dataKey2.col_name) !== null && _b !== void 0 ? _b : f.customFiltervar2, customFiltervar3: (_c = dataKey3 === null || dataKey3 === void 0 ? void 0 : dataKey3.col_name) !== null && _c !== void 0 ? _c : f.customFiltervar3 });
            });
            graphData.customVariable = graphData.customVariable.map((variable) => {
                if (variable.is_filter || variable.is_slab) {
                    variable.filters = variable.filters.map((f) => {
                        ...
                        if (!f.isCustomValue) {
                            ...
                            f.values = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : f.values;
                        }
                        f.conditions = f.conditions.map((condition) => {
                            var _a;
                            let dataKey = dataKeys.find((key) => key.col_title == condition.variable.name);
                            condition.variable.name =
                                (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : condition.variable.name;
                            return condition;
                        });
                        return f;
                    });
                    ...
                    variable.operation = variable.operation.map((op) => {
                        ...
                        if (!op.isCustomValue) {
                            ...
                            op.value = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : op.value;
                        }
                        return op;
                    });
                }
            ...
            graphData.dataFormat = graphData.dataFormat.map((format) => {
                ...
                return Object.assign(Object.assign({}, format), { name: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.col_name) !== null && _a !== void 0 ? _a : format.name });
            });
        }
        return graphData;
    }
...
class XSightsCoreService {
        ...
        return new Promise((resolve, reject) => {
            switch (widgetType) {
                case WidgetType$1.GRAPH:
                    resolve(this.buildGraph(Object.assign(Object.assign({}, widgetData), { breadCrumb: ['Home'], currLevel: 0, prevLevelData: [], selKeys: [], order: 0, colToShow: '' })));
                    break;
                case WidgetType$1.TREND:
                    let widget = widgetData;
                    resolve(this.buildTrend(Object.assign(Object.assign({}, widget), { rawData: widget.graphData, currLevel: 1, order: 0, prevLevelData: [] })));
                    break;
    ...
    buildGraph(graphData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.charts[graphData.graphId].rows[this.charts[graphData.graphId].currLevel] == '***LABEL***') {
                //Create Label Block
                let response = yield this.publishLabel(graphData.graphId);
                //Dispatch after build event
                return response;
            }
            else {
                //Create Graph
                let response = yield this.startGraphBuilder(graphData.graphId, this.charts[graphData.graphId].currLevel, '');
                //Dispatch after build event
                return response;
            }
        });
    }
    publishLabel(graphId) {
        return __awaiter(this, void 0, void 0, function* () {
            //Flush Content of Graph Div
            document.querySelector('#' + graphId).innerHTML = '';
            //Add Custom Variable in Raw Data
            let data = yield this.addCustomVariable(this.charts[graphId].customVariable, this.charts[graphId].graphData, false, this.charts[graphId].dataFormat, false);
    ...
    startGraphBuilder(graphId, currLevel, colToShow) {
        return __awaiter(this, void 0, void 0, function* () {
            //Add Custom Slabs in Raw Data
            let data = yield this.addCustomVariable(this.charts[graphId].customVariable, this.charts[graphId].graphData, true, this.charts[graphId].dataFormat, true);
            ...
            chart: {
                events: {
                    ...
                    drilldown: function (e) {
                        ...
                        (_a = _self.charts[currGraphId].selKeys) === null || _a === void 0 ? void 0 : _a.push(e.point.name);
    ...
    manageBreadCrumb(graphId, _self) {
        ...
        (_a = document.getElementById("breadcrumb-" + graphId)) === null || _a === void 0 ? void 0 : _a.remove();
            ...
            if (index != this.charts[graphId].breadCrumb.length - 1) {
                ...
                span.addEventListener("click", (event) => {
                    ...
                    if (event.target.id == "Home") {
                        ...
                        _this.buildGraph(Object.assign(Object.assign({}, _this.charts[graphId]), { breadCrumb: ['Home'], currLevel: 0, prevLevelData: [], order: 0, selKeys: [], colToShow: '' }));
                    }
                    else {
                        ...
                        if (index > 0) {
                            ...
                            _this.charts[graphId].selKeys = (_a = _this.charts[graphId].selKeys) === null || _a === void 0 ? void 0 : _a.slice(0, index);
                            console.log('_this.charts[graphId]: ', _this.charts[graphId]);
                            _this.buildGraph(Object.assign({}, _this.charts[graphId]));
                        }
                    }
                });
            }
    ...
    applyAggregation(allData, yIndex, aggreagations) {
        ...
        switch (aggreagations[yIndex].aggregationFunctions) {
            ...
            case 'MAXIMUM' /* MAXIMUM */:
                result = (_a = lodash.max(allData.map(Number))) !== null && _a !== void 0 ? _a : 0;
                break;
            case 'MINIMUM' /* MINIMUM */:
                result = (_b = lodash.min(allData.map(Number))) !== null && _b !== void 0 ? _b : 0;
                break;
        ...
        lodash.forEach(customVariable, (variable, index) => {
            if (variable.is_filter) {
                    ...
                    if (filter.isCustomValue || !withoutAgg) {
                        ...
                        if (filter.isCustomValue) {
                            ...
                            let value = this.validateNumber(filter.values)
                                ...
                                : filter.values;
                            resultantData = [
                                ...lodash.map(lodash.cloneDeep(filteredData), (d) => (Object.assign(Object.assign({}, d), { [variable.name]: value }))),
                            ...
                            resultantData = [
                                ...lodash.map(lodash.cloneDeep(filteredData), (d) => (Object.assign(Object.assign({}, d), { [variable.name]: value == null ? d[filter.values] : value }))),
                                ...lodash.cloneDeep(residingData),
                            ];
                        }
                        filteredData = null;
                ...
                if (variable.operation[0].isAggregation && !withoutAgg) {
                    ...
                    resultantData = lodash.map(resultantData, (d) => (Object.assign(Object.assign({}, d), { [variable.name]: this.getCustomVariableValue(variable, d) })));
                }
            }
    ...
    getAggregatedValueOfCustomVariable(allData, filter) {
        ...
        switch (filter.aggregationFunction) {
            ...
            case "MINIMUM" /* MINIMUM */:
                ...
                break;
            case "AVERAGE" /* AVERAGE */:
                result = (_c = lodash.mean(allData.map(Number))) !== null && _c !== void 0 ? _c : 0;
                break;
        }
        return result;
    }
    ...
    getCustomVariableValueAggregated(variable, data) {
        ...
        return lodash.map(data, (d) => (Object.assign(Object.assign({}, d), { [variable.name]: value })));
    }
    //trends Data
    ...
    initTrend(graphId) {
        return __awaiter(this, void 0, void 0, function* () {
            //Creating Chart Raw Json
            const trendData = yield this.createTrendData(graphId);
            //Rendering Chart of GraphId
                    ...
                    if (graph.graphType != 2) {
                        ...
                        if (dataIndex != -1) {
                            ...
                            let tempGraphData = {
                                ...
                                dataFormat: [],
                                colToShow: null,
                                lastLevelColumns: (_a = graph.graph_structure.lastLevelData) !== null && _a !== void 0 ? _a : [],
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (widgetData.graphType == 1) {
                let graphData = {
                    ...
                    comparison: (_a = widgetData.graph_structure.comparison) !== null && _a !== void 0 ? _a : [],
                    customVariable: tempData.customVariable,
                    dataFormat: (_b = tempData.dataFormat) !== null && _b !== void 0 ? _b : [],
                    lastLevelColumns: (_c = tempData.lastLevelColumns) !== null && _c !== void 0 ? _c : [],
                };
                let response = yield _self.xsights.build(WidgetType$1.TREND, graphData);
                resolve(response);
                ...
                let tableData = {
                    ...
                    dataFormat: (_d = tempData.dataFormat) !== null && _d !== void 0 ? _d : [],
                    data: data,
                    categories: widgetData.graph_structure.chartType,
                };
                _self.tableDatas['table-graph-' + widgetData.graph_id] =
                    yield _self.xsights.build(WidgetType$1.PIVOT_TABLE, tableData);
                resolve(true);
                setTimeout(() => {
                    _self.checkDashboardLoading();
                }, 500);
                ...
                let graphdata = {
                    ...
                    filter: tempData.filter,
                    customVariable: tempData.customVariable,
                    dataFormat: (_e = tempData.dataFormat) !== null && _e !== void 0 ? _e : [],
                    lastLevelColumns: (_f = tempData.lastLevelColumns) !== null && _f !== void 0 ? _f : [],
                    graphTypes: widgetData.graph_structure.chartType,
                    graphData: data,
                    colors: widgetData.graph_structure.colColours,
                };
                let response = yield this.xsights.build(WidgetType$1.GRAPH, graphdata);
                resolve(response);
                _self.checkDashboardLoading();
            }
        }));
...
class XSightsDashboardComponent {
    ...
    ngOnChanges(changes) {
        ...
        // }
        if (((_a = changes['dashboardId']) === null || _a === void 0 ? void 0 : _a.currentValue) !=
            ((_b = changes['dashboardId']) === null || _b === void 0 ? void 0 : _b.previousValue) ||
            ((_c = changes['adminId']) === null || _c === void 0 ? void 0 : _c.currentValue) != ((_d = changes['adminId']) === null || _d === void 0 ? void 0 : _d.previousValue) ||
            ((_e = changes['showHeader']) === null || _e === void 0 ? void 0 : _e.currentValue) !=
                ((_f = changes['showHeader']) === null || _f === void 0 ? void 0 : _f.previousValue) ||
            ((_g = changes['showFilters']) === null || _g === void 0 ? void 0 : _g.currentValue) !=
                ((_h = changes['showFilters']) === null || _h === void 0 ? void 0 : _h.previousValue) ||
            ((_j = changes['toggleDashboard']) === null || _j === void 0 ? void 0 : _j.currentValue) !=
                ((_k = changes['toggleDashboard']) === null || _k === void 0 ? void 0 : _k.previousValue)) {
            this.renderPage();
        }
    }
    refreshSystemApis() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let index = 0; index < this.dashboardData.graphs.length; index++) {
                ...
                if (graph.sourceid.toString() == '138') {
                    ...
                    let res = yield _self.generateDashboard(graph, !calledOnce);
                    let tempGraphData = {
                        rows: graph.graph_structure.xAxis,
                        columns: graph.graph_structure.yAxis,
                        aggregationFunctions: graph.graph_structure.aggreagations,
                    ...
                    let tempGraphData = {
                        ...
                        colToShow: null,
                        chartType: graph.graph_structure.chartType,
                        lastLevelColumns: (_b = graph.graph_structure.lastLevelData) !== null && _b !== void 0 ? _b : [],
                        dateVariable: graph.graph_structure.dateVariable,
                    };
                    if (graph.sourceid.toString() == this.mtrSource) {
                        tempGraphData = this.dataService.keyConverter(tempGraphData, this.calledSourceKeys[graph.sourceid.toString()], 1);
    ...
    getDashBoardById() {
        this.dataService
            ...
            var _a, _b, _c;
            this.filters = (_b = (_a = res.data[0]) === null || _a === void 0 ? void 0 : _a.filters) !== null && _b !== void 0 ? _b : [];
            res.data[0].graphs = res.data[0].graphs.sort(this.setGraphOrder);
            this.dashboardData = res.data[0];
            for (const element of this.dashboardData.graphs) {
                const graph = element;
                if (graph.graphType != 2) {
                    let res = yield this.generateDashboard(graph);
                    let tempGraphData = {
                        rows: graph.graph_structure.xAxis,
                        columns: graph.graph_structure.yAxis,
                        aggregationFunctions: graph.graph_structure.aggreagations,
                        ...
                        dataFormat: [],
                        colToShow: null,
                        lastLevelColumns: (_c = graph.graph_structure.lastLevelData) !== null && _c !== void 0 ? _c : [],
                        chartType: graph.graph_structure.chartType,
                        dateVariable: graph.graph_structure.dateVariable,
                    };
                    if (graph.sourceid.toString() == this.mtrSource) {
    ...
    generateDashboard(graph, reCall = false) {
        return new Promise((resolve, reject) => {
            ...
            if (this.calledSource.hasOwnProperty(graph.sourceid.toString()) &&
                ...
                let extraData = {
                    startTime: ((_a = this.startDate) !== null && _a !== void 0 ? _a : this.fromDate) + ' 00:00:00',
                    endTime: ((_b = this.endDate) !== null && _b !== void 0 ? _b : this.toDate) + ' 00:00:00',
                };
                this.dataService
                    .fetchDataSource({
    ...
    buildChart(widgetData, data, tempData) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (existIndex == -1) {
                ...
                _self.dataFile[existIndex] = Object.assign(Object.assign({}, _self.dataFile[existIndex]), { data: existSourceIndex != -1 ? existSourceIndex : data });
            }
            data = this.filterData(data, widgetData.sourceid.toString());
            if (widgetData.graphType == 1) {
                let range = {
                ...
                if (this.systemApis.includes(widgetData.sourceid.toString())) {
                    range = {
                        startDate: (_a = this.startDate) !== null && _a !== void 0 ? _a : this.fromDate,
                        endDate: (_b = this.endDate) !== null && _b !== void 0 ? _b : this.toDate,
                    };
                }
                let graphData = {
                    graphId: 'graph-' + widgetData.graph_id,
                    ...
                    dateVariable: tempData.dateVariable,
                    rangeFilter: widgetData.graph_structure.rangeFilter,
                    comparison: (_c = widgetData.graph_structure.comparison) !== null && _c !== void 0 ? _c : [],
                    customVariable: tempData.customVariable,
                    dataFormat: (_d = tempData.dataFormat) !== null && _d !== void 0 ? _d : [],
                    lastLevelColumns: (_e = tempData.lastLevelColumns) !== null && _e !== void 0 ? _e : [],
                };
                let response = yield _self.xsights.build(WidgetType$1.TREND, graphData);
                ...
                let tableData = {
                    ...
                    filter: tempData.filter,
                    derivedVariables: tempData.customVariable,
                    dataFormat: (_f = tempData.dataFormat) !== null && _f !== void 0 ? _f : [],
                    data: data,
                    categories: widgetData.graph_structure.chartType,
                };
                ...
                let graphdata = {
                    ...
                    filter: tempData.filter,
                    customVariable: tempData.customVariable,
                    dataFormat: (_g = tempData.dataFormat) !== null && _g !== void 0 ? _g : [],
                    lastLevelColumns: (_h = tempData.lastLevelColumns) !== null && _h !== void 0 ? _h : [],
                    graphTypes: widgetData.graph_structure.chartType,
                    graphData: data,
                    colors: widgetData.graph_structure.colColours,
                };
    ...
    filteredDashboard() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (let index = 0; index < this.dashboardData.graphs.length; index++) {
                ...
                let res = null;
                if (graph.graphType != 2) {
                    res = yield this.generateDashboard(graph);
                    let tempGraphData = {
                        rows: graph.graph_structure.xAxis,
                        columns: graph.graph_structure.yAxis,
                        aggregationFunctions: graph.graph_structure.aggreagations,
...
class XsightsBackendService {
    ...
    buildGraph(graphData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.charts[graphData.graphId].rows[this.charts[graphData.graphId].currLevel] == '***LABEL***') {
                ...
                //Create Graph
                let response = yield this.startGraphBuilder(graphData.graphId);
                //Dispatch after build event
                return response;
            }
        });
        ...
        `)
            ...
            document.querySelectorAll('#card-graph-' + graphId).forEach((card) => card.addEventListener('click', function (e) {
                ...
                let dataObj = {
                    ...
                    shareid: (_b = _self.charts[graphId].shareid) !== null && _b !== void 0 ? _b : null,
                    startDate: (_c = _self.charts[graphId].range.startDate) !== null && _c !== void 0 ? _c : null,
                    endDate: (_d = _self.charts[graphId].range.endDate) !== null && _d !== void 0 ? _d : null
                };
                Swal.fire({
                    text: "Please Wait...",
                    allowOutsideClick: false
            ...
            chart: {
                events: {
                    ...
                    drilldown: function (e) {
                        ...
                        (_b = _self.charts["graph-" + currGraphId].selKeys) === null || _b === void 0 ? void 0 : _b.push(e.point.name);
                        let dataObj = {
                            graphId: currGraphId,
                            ...
                            shareid: (_c = _self.charts["graph-" + currGraphId].shareid) !== null && _c !== void 0 ? _c : null,
                            startDate: (_d = _self.charts["graph-" + currGraphId].range.startDate) !== null && _d !== void 0 ? _d : null,
                            endDate: (_e = _self.charts["graph-" + currGraphId].range.endDate) !== null && _e !== void 0 ? _e : null
                        };
                        _self.dataService.getGraphDrilldownById(dataObj).then((res) => {
                            var _b;
                            //Open Last Level Component
                            if (_self.charts["graph-" + currGraphId].rows.length == _self.charts["graph-" + currGraphId].currLevel) {
                                ...
                                //Reducing Graph Drilldown Level
                                _self.charts["graph-" + currGraphId].currLevel -= 1;
                                (_b = _self.charts["graph-" + currGraphId].selKeys) === null || _b === void 0 ? void 0 : _b.pop();
                                setTimeout(() => {
                                    //Hide Loading in chart
                                    chart.hideLoading();
                                }, 1000);
    ...
    sortGraph(e) {
        ...
        let d = {
            ...
            shareid: (_b = this.charts[graphId].shareid) !== null && _b !== void 0 ? _b : null,
            startDate: (_c = this.charts[graphId].range.startDate) !== null && _c !== void 0 ? _c : null,
            endDate: (_d = this.charts[graphId].range.endDate) !== null && _d !== void 0 ? _d : null
        };
        Swal.fire({
            text: "Please Wait...",
            allowOutsideClick: false
        ...
        this.dataService.getGraphDataById(d).then((res) => {
            ...
            this.buildGraph(Object.assign(Object.assign({}, this.charts[graphId]), { breadCrumb: ['Home'], currLevel: 0, selKeys: [], order: 0, prevLevelData: [], colToShow: '' }));
        });
    }
    addActionBtn(graphId) {
        let _self = this;
    ...
    manageBreadCrumb(graphId, _self) {
        var _b;
        const div = document.getElementById("graph-options-" + graphId);
        (_b = document.getElementById("breadcrumb-" + graphId)) === null || _b === void 0 ? void 0 : _b.remove();
        const breadCrumb = document.createElement("div");
        if (_self.charts[graphId].breadCrumb.length == 1) {
            return;
        }
                ...
                span.addEventListener("click", (event) => {
                    ...
                    if (event.target.id == "Home") {
                        ...
                        if (index > 0) {
                            ...
                            _this.charts[graphId].prevLevelData = _this.charts[graphId].prevLevelData.slice(0, index);
                            _this.charts[graphId].breadCrumb = _this.charts[graphId].breadCrumb.slice(0, index + 1);
                            _this.charts[graphId].selKeys = (_e = _this.charts[graphId].selKeys) === null || _e === void 0 ? void 0 : _e.slice(0, index);
                            console.log('_this.charts[graphId]: ', _this.charts[graphId]);
                            _this.buildGraph(Object.assign({}, _this.charts[graphId]));
                        }
                    }
    ...
    addActionBtnTrends(graphId) {
        ...
        submitButton.addEventListener('click', function () {
            ...
            let d = {
                ...
                shareid: (_b = _self.trends[graphId].shareid) !== null && _b !== void 0 ? _b : null,
                ...
                events: {
                    ...
                    drilldown: function (e) {
                        ...
                        let dataObj = {
                            ...
                            shareid: (_b = _self.trends["graph-" + currGraphId].shareid) !== null && _b !== void 0 ? _b : null,
            ...
            this.dataService.getGraphDataById(d).then((res) => {
                ...
                if (this.graphData.graphtype != 2) {
                    let tempGraphData = {
                        ...
                        dataFormat: [],
                        colToShow: null,
                        lastLevelColumns: (_a = structure.lastLevelData) !== null && _a !== void 0 ? _a : [],
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (widgetData.graphtype == 1) {
                ...
                let graphData = {
                    ...
                    comparison: (_a = tempData.comparison) !== null && _a !== void 0 ? _a : [],
                    customVariable: tempData.customVariable,
                    dataFormat: (_b = tempData.dataFormat) !== null && _b !== void 0 ? _b : [],
                    lastLevelColumns: (_c = tempData.lastLevelColumns) !== null && _c !== void 0 ? _c : [],
                    selKeys: [],
                ...
                let response = yield _self.xsightsBackend.build(WidgetType$1.TREND, graphData);
                resolve(response);
            }
            else if (widgetData.graphtype == 3) {
                let tableData = {
    ...
    getGraphDashBoardById() {
        ...
        this.filters.forEach((f) => {
            if (filter[f.sourceId]) {
                filter[f.sourceId] = Object.assign(Object.assign({}, filter[f.sourceId]), { [f.fieldName]: f.selValues.map((value) => value.text) });
            }
            else {
                filter[f.sourceId] = {
        ...
        this.dataService
            ...
            var _a, _b, _c;
            this.showLoading.emit(false);
            this.filters = this.filters.length == 0 ? (_b = (_a = res.data[0]) === null || _a === void 0 ? void 0 : _a.filters.map((filter) => {
                ...
                return filter;
            })) !== null && _b !== void 0 ? _b : [] : this.filters;
            this.seriesData = (_c = res.data[0]) === null || _c === void 0 ? void 0 : _c.seriesData;
            res.data[0].graphs = res.data[0].graphs.sort(this.setGraphOrder);
            this.dashboardData = res.data[0];
            setTimeout(() => {
                var _a;
    ...
    renderTable() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.tableGraphs.length > 0) {
                this.tableGraphs.forEach((graph) => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    let data = yield this.generateDashboard(graph, false);
                    console.log('data: ', data);
                    let tempGraphData = {
                        rows: graph.graph_structure.xAxis,
                        columns: graph.graph_structure.yAxis,
        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.calledSourceData.hasOwnProperty(graph.sourceid.toString()) &&
                ...
                let d = {
                    ...
                    adminId: this.adminId,
                    shareid: null,
                    startTime: (_a = this.startDate) !== null && _a !== void 0 ? _a : this.fromDate,
                    endTime: (_b = this.endDate) !== null && _b !== void 0 ? _b : this.toDate
                };
                this.dataService.getGraphDataById(d).then((res) => {
                    Swal.hideLoading();
                    Swal.close();
            ...
            for (const element of this.dashboardData.graphs) {
                ...
                if (graph.graphType != 2 && graph.graphType != 3) {
                    ...
                    let tempGraphData = {
                        ...
                        dataFormat: [],
                        colToShow: null,
                        lastLevelColumns: (_d = graph.graph_structure.lastLevelData) !== null && _d !== void 0 ? _d : [],
                        chartType: graph.graph_structure.chartType,
                        dateVariable: graph.graph_structure.dateVariable,
                    };
                    this.buildChart(graph, res, tempGraphData, this.selFilters);
