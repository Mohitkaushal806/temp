                    ...
                    if (filter.isCustomValue || !withoutAgg) {
                        ...
                        if (filter.isCustomValue) {
                            ...
                            let value = this.validateNumber(filter.values)
                                ...
                                : filter.values;
                            resultantData = [
                                ...lodash.map(filteredData, (d) => (Object.assign(Object.assign({}, d), { [variable.name]: value }))),
                                ...residingData,
                            ];
                        }
                        else {
                            ...
                            resultantData = [
                                ...lodash.map(filteredData, (d) => (Object.assign(Object.assign({}, d), { [variable.name]: value == null ? d[filter.values] : value }))),
                                ...residingData,
                            ];
                        }
                    }
