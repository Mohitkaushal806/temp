    ...
    keyConverter(graphData, dataKeys, direction = 1) {
        ...
        if (direction === 1) {
            graphData.rows = graphData.rows.map((row) => {
                ...
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : row;
            });
            graphData.columns = graphData.columns.map((column) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.name == column);
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : column;
            });
            ...
            if (graphData.colToShow != null) {
                ...
                graphData.colToShow = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : graphData.colToShow;
            }
            graphData.aggregationFunctions = graphData.aggregationFunctions.map((func) => {
                ...
                return Object.assign(Object.assign({}, func), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : func.variableName });
            });
            graphData.filter.xAxis = graphData.filter.xAxis.map((f) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.name == f.variableName);
                return Object.assign(Object.assign({}, f), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : f.variableName });
            });
            ...
            graphData.filter.customFilter = graphData.filter.customFilter.map((f) => {
                ...
                return Object.assign(Object.assign({}, f), { customFiltervar1: (_a = dataKey1 === null || dataKey1 === void 0 ? void 0 : dataKey1.title) !== null && _a !== void 0 ? _a : f.customFiltervar1, customFiltervar2: (_b = dataKey2 === null || dataKey2 === void 0 ? void 0 : dataKey2.title) !== null && _b !== void 0 ? _b : f.customFiltervar2, customFiltervar3: (_c = dataKey3 === null || dataKey3 === void 0 ? void 0 : dataKey3.title) !== null && _c !== void 0 ? _c : f.customFiltervar3 });
            });
                ...
                if (variable.is_filter || variable.is_slab) {
                    variable.filters = variable.filters.map((f) => {
                        ...
                        if (!f.isCustomValue) {
                            ...
                            f.values = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : f.values;
                        }
                        f.conditions = f.conditions.map((condition) => {
                            var _a;
                            let dataKey = dataKeys.find((key) => key.name == condition.variable.name);
                            condition.variable.name =
                                (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : condition.variable.name;
                            return condition;
                        });
                        return f;
                    });
                    ...
                    variable.operation = variable.operation.map((op) => {
                        ...
                        if (!op.isCustomValue) {
                            ...
                            op.value = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : op.value;
                        }
                        return op;
                    });
                }
            ...
            graphData.dataFormat = graphData.dataFormat.map((format) => {
                ...
                return Object.assign(Object.assign({}, format), { name: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.title) !== null && _a !== void 0 ? _a : format.name });
            });
        }
        else {
            graphData.rows = graphData.rows.map((row) => {
                ...
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : row;
            });
            graphData.columns = graphData.columns.map((column) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.title == column);
                return (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : column;
            });
            graphData.lastLevelColumns = graphData.lastLevelColumns.map((column) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.title == column);
            ...
            if (graphData.colToShow != null) {
                ...
                graphData.colToShow = (_b = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _b !== void 0 ? _b : graphData.colToShow;
            }
            graphData.aggregationFunctions = graphData.aggregationFunctions.map((func) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.title == func.variableName);
                return Object.assign(Object.assign({}, func), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : func.variableName });
            });
            graphData.filter.xAxis = graphData.filter.xAxis.map((f) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.title == f.variableName);
                return Object.assign(Object.assign({}, f), { variableName: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : f.variableName });
            });
            graphData.filter.yAxis = graphData.filter.yAxis.map((f) => {
                var _a;
                let dataKey = dataKeys.find((key) => key.title == f.variableName);
            ...
            graphData.filter.customFilter = graphData.filter.customFilter.map((f) => {
                ...
                return Object.assign(Object.assign({}, f), { customFiltervar1: (_a = dataKey1 === null || dataKey1 === void 0 ? void 0 : dataKey1.name) !== null && _a !== void 0 ? _a : f.customFiltervar1, customFiltervar2: (_b = dataKey2 === null || dataKey2 === void 0 ? void 0 : dataKey2.name) !== null && _b !== void 0 ? _b : f.customFiltervar2, customFiltervar3: (_c = dataKey3 === null || dataKey3 === void 0 ? void 0 : dataKey3.name) !== null && _c !== void 0 ? _c : f.customFiltervar3 });
            });
            graphData.customVariable = graphData.customVariable.map((variable) => {
                if (variable.is_filter || variable.is_slab) {
                    variable.filters = variable.filters.map((f) => {
                        ...
                        if (!f.isCustomValue) {
                            ...
                            f.values = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : f.values;
                        }
                        f.conditions = f.conditions.map((condition) => {
                            var _a;
                            let dataKey = dataKeys.find((key) => key.title == condition.variable.name);
                            condition.variable.name =
                                (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : condition.variable.name;
                            return condition;
                        });
                        return f;
                    });
                    ...
                    variable.operation = variable.operation.map((op) => {
                        ...
                        if (!op.isCustomValue) {
                            ...
                            op.value = (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : op.value;
                        }
                        return op;
                    });
                }
            ...
            graphData.dataFormat = graphData.dataFormat.map((format) => {
                ...
                return Object.assign(Object.assign({}, format), { name: (_a = dataKey === null || dataKey === void 0 ? void 0 : dataKey.name) !== null && _a !== void 0 ? _a : format.name });
            });
        }
        return graphData;
    }
